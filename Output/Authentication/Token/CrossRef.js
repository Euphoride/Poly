...
function CrossReference(tokenPack) {
    return __awaiter(this, void 0, void 0, function () {
        var found, toFind, returnPack, _a, _b, _i, tokenName, collection, search, tokenInformation, tokenInformationKey;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    found = 0;
                    toFind = CR_INFO.length;
                    returnPack = {};
                    _a = [];
                    for (_b in TOKEN_REF)
                        _a.push(_b);
